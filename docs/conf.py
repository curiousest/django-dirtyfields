...
copyright = '2015, Romain Garrigues'
...
latex_documents = [
  (master_doc, 'django-dirtyfields.tex', 'django-dirtyfields Documentation',
   'Romain Garrigues', 'manual'),
]
...
man_pages = [
    (master_doc, 'django-dirtyfields', 'django-dirtyfields Documentation',
     [author], 1)
]
